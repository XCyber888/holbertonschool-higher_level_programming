#!/usr/bin/python3
"""Rectangle class with delete message.

This module defines a Rectangle class with private width and height attributes,
getters/setters, area, perimeter, string representation, and delete message.
"""


class Rectangle:
    """Class that defines a rectangle with delete message."""

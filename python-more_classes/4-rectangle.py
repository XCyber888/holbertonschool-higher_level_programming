#!/usr/bin/python3
"""Rectangle class with eval support.

This module defines a Rectangle class with private width and height attributes,
getters/setters, area, perimeter, string representation, and repr for eval.
"""


class Rectangle:
    """Class that defines a rectangle with eval support."""
